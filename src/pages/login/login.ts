...
export class LoginPage {
  ...
  userProfile: any
  loginForm : FormGroup
  constructor(public navCtrl: NavController, public navParams: NavParams , private _external : External , private _fb: FormBuilder , private _storage: StorageSession , private _alert: AlertController) {
  ...
  facebookRegister(){
      Facebook.login(['email']).then( (response) => {
          ...
          Facebook.api(response.authResponse.userID + '/?fields=id,email,first_name,last_name', []).then((data)=>{
