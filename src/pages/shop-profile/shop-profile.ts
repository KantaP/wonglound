...
export class ShopProfilePage {
  ...
  public toastCtrl: ToastController, public platform: Platform, public loadingCtrl: LoadingController , private _alert: AlertController) {
    this._moment = moment
      ...
      buttons: [
        {
          ...
          handler: () => {
            this.takePicture(Camera.PictureSourceType.PHOTOLIBRARY , imagesId);
          }
        },
        {
          text: 'Use Camera',
          handler: () => {
            this.takePicture(Camera.PictureSourceType.CAMERA , imagesId);
          }
        },
        {
          text: 'Cancel',
