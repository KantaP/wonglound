...
export class ProfilePage {
  ...
  public actionSheetCtrl: ActionSheetController, public toastCtrl: ToastController, public platform: Platform, public loadingCtrl: LoadingController , public _param: Paramservice ) {
    // this.userProfile = {
    //   firstname: '',
    //   surname: '',
    //   sex: '',
